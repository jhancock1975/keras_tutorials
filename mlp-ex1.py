...
logging.debug('create Tensorboard callback object')
keras.callbacks.TensorBoard(log_dir=const.tb_log_dir, histogram_freq=0,  
          write_graph=True, write_images=True)

tbCallBack = keras\
             .callbacks\
             .TensorBoard(log_dir=const.tb_log_dir, histogram_freq=0,
               write_graph=True, write_images=True)
